// This new file will hold all your service content.
// It's the "single source of truth" for your site.
    ...
    subServices: [
      {
        ...
        text: "Our internal audit services move beyond traditional compliance checks. We adopt a risk-based approach to provide assurance on your governance and control processes, identify areas for operational improvement, and help you achieve strategic objectives."
      },
      {
        title: "Standard Operating Procedures (SOPs)",
        text: "We assist in developing and documenting robust SOPs that standardize your business processes, improve efficiency, strengthen internal controls, and ensure consistency across your organization."
      },
      {
        title: "Enterprise Risk Management (ERM)",
        text: "We partner with you to implement a comprehensive ERM framework, enabling you to proactively identify, assess, and respond to strategic, operational, financial, and compliance risks across your entire enterprise."
      }
    ]
  },
  {
    ...
    subServices: [
      {
        ...
        text: "We conduct statutory audits as required under the Companies Act and other regulations, providing an independent opinion on the truth and fairness of your financial statements. Our risk-based methodology ensures an efficient and effective audit."
      },
      {
        title: "Tax audit",
        text: "Our tax audit services ensure compliance with the provisions of the Indian Income Tax Act. We meticulously review your financial records to verify the correctness of income, deductions, and tax computations, minimizing the risk of disputes."
      },
      {
        title: "Risk Assurance Services / Internal Audit",
        text: "We provide assurance on your key internal controls, governance processes, and risk management frameworks. Our services are designed to identify control weaknesses, suggest improvements, and help you manage risks effectively."
      }
    ]
  },
  {
    ...
    subServices: [
      ...
      },
      {
        ...
        text: "We assist in the preparation of complex restated financial statements as required by SEBI and other regulatory bodies, ensuring they are fully compliant with accounting standards and listing regulations."
      }
    ]
  },
  {
